...
char plc_program_md5[] = "a2e46538ee2c1156dc935b76f3c31a75";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.CRAC_FAN_STATUS), BOOL_ENUM},
    {&(RES0__INSTANCE0.TEMP_HIGH_ALARM), BOOL_ENUM},
    {&(RES0__INSTANCE0.SENSOR_TEMP), INT_O_ENUM},
    {&(RES0__INSTANCE0.FAN_SPEED), INT_O_ENUM},
    {&(RES0__INSTANCE0.SENSOR_POWER), INT_O_ENUM},
    {&(RES0__INSTANCE0.OVERHEAT_ALARM), BOOL_O_ENUM},
    {&(RES0__INSTANCE0._TMP_GT4543488_OUT), BOOL_ENUM},
};
